    ...
    <div class="container_article font_text">
        ...
        <div>
            ...
            <p>
                ...
                <span class="line">
                    Master pro conduite de projets, métiers du livre et du multimédia ( <span class="lightgrey">Clermont-Ferrand</span> ) <br>
                    Master pro conseil éditorial et gestion des connaissances numériques ( <span class="lightgrey">Paris 4</span> ) <br>
                    Master pro édition contemporaine numérique ( <span class="lightgrey">Brest</span> ) <br>
                    Master pro édition, édition multimédia et rédaction professionnelle ( <span class="lightgrey">Angers</span> ) <br>
                    Master pro livre et multimédia ( <span class="lightgrey">Paris-Est</span> ) <br>
                    Master pro conception et intégration numérique ( <span class="lightgrey">Lyon 2</span> ) <br>
                    Master création éditoriale multi-supports – CREM ( <span class="lightgrey">Paris Sorbonne</span> ) <br>
                    Master édition ( <span class="lightgrey">Limoges</span> ) <br>
                    Master ingénierie éditoriale et communication ( <span class="lightgrey">Cergy Pontoise</span> ) 
                </span>
            </p>

            <p>Plus de détails sur les masters - <a href="http://www.trouvermonmaster.gouv.fr" target="_blank"> <span class="lightgrey"> www.trouvermonmaster.gouv.fr</span></a></p>
        </div>
        ...
        <div>
            ...
            <p>
                Très intéressé par le domaine des technologies, il a des compétences techniques en informatique et il sait de quoi il parle avec ses collaborateurs. Ce sont les formations informatiques, ingénieurs, ou encore jeux vidéos qui donnent ces compétences au chef de projet numérique.
            </p>
