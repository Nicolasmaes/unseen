    ...
    <div class="container_article font_text">
        <div>
            ...
            <p>
                ...
                <span class="line">
                la confidentialitée : empêcher la lecture d’un message par une personne non-autorisée. <br>
                l’authenticitée : permettre de « signer » un message pour assurer qu’il est envoyer par la bonne personne. <br>
                l’intégritée : mise en place de protocoles permettant de vérifier que le message n’a pas été modifier de manière frauduleuse. <br>
                </span>
            </p>
            ...
            <p>
                ...
                crptanalyse : science de l’étude des messages chiffrées en vue de leur déchiffrement. <br>
        ...
        <div>
            ...
            <p>
                ...
                un procédé cryptographique de certification du dommaine ( <span class="lightgrey">pour s’assurer que l’on ne se trouve pas sur un faux site destiné à voler notre mot de passe via le formulaire d’entrée</span> ). <br><br>
        ...
        <div>   
            ...
            <p class="line">
                ...
                <span class="lightgrey">Developpeur spécialiser dans le cryptage des données sensibles.</span> <br><br>
               
                
                <span class="bold">Analyste en sécurité</span> <br>
                <span class="lightgrey">Vérifie que les systemes de sécuritée d’une entreprise/d’un réseau fonctionnes et répondent aux standards actuels.</span> <br><br>
                
                <span class="bold">Ingénieur en sécurité</span> <br>
                <span class="lightgrey">Métier consistant a élaborer la sécuritée d’un réseau (proche de analyste en sécuritée, qui prend en quelque sorte la suite des opérations).</span> <br><br>
                
                <span class="bold">Consultant en sécurité</span> <br>
                <span class="lightgrey">Il s’agit fréquement d’une personne/organisme exterieur qui donne des conseils, des recommendations et aide a la mise en place de ceux-ci.</span> <br><br>
                
                <span class="bold">Pentester</span> <br>
                <span class="lightgrey">Le pentesteur cherche des failles de sécuritée dans le but de les corrigé. en claire, il s’agit de faire le travail d’un pirate pour réglé les failles avant qu’un réel pirate ne les exploites. Le pentester est souvent confronté a la cryptographie, il peut être notament utile qu’il soit formé à la cryptanalyse. ( voir Le Pentesteur ou le Corsaire des Hackers, sur la fiche wiliams.md )</span> <br><br>
                
                <span class="bold">Technicien réseau</span> <br>
                <span class="lightgrey"></span>Le technicien réseau peut être amené à géré la sécuritée des serveurs et des données échangées, il peut donc aussi lui être demandé d’avoir des compétences en cryptologie.</span> <br><br>
                
                <span class="bold">Cryptologue</span> <br>
                <span class="lightgrey">Cryptologue n’est pas un métier que l’on est ammené a trouver fréquement dans une entreprise. Il s’agit en fait plus d’un mathématicien (voir d’un physicien) qui invente de nouvelles méthodes de cryptage (voir qui cherche les méthodes permettant de casser le code sans la clef). Il existes de nombreuses sous-disciplines dans ce dommaine (Cryptanalyse, Cryptographie symétrique, Cryptographie asymétrique, Cryptographie quantique et post-quantique).</span> <br><br>
            </p>
        </div>
