...
<div class="margin_two">
    ...
    <div class="category_specific">
            ...
            <div class="category_specific__item">
                <span class="category_specific__item__title">Le développeur web</span>
                    
                    <img src="../assets/images/svg/versatile/logo_web_developer.svg" alt="">
            ...
            <div class="category_specific__item reverse">
                    ...
                    <img src="../assets/images/svg/versatile/logo_community_manager.svg" alt="">
            ...
            <div class="category_specific__item ">
                    ...
                    <img src="../assets/images/svg/versatile/logo_communication_agency.svg" alt="">
            ...
            <div class="category_specific__item reverse ">
                    ...
                    <img src="../assets/images/svg/versatile/logo_web_designer.svg" alt="">
            ...
            <div class="category_specific__item  ">
                    ...
                    <img src="../assets/images/svg/versatile/logo_web_work.svg" alt="">
            ...
            <div class="category_specific__item reverse ">
                    ...
                    <img src="../assets/images/svg/versatile/logo_devops.svg" alt="">
            ...
            <div class="category_specific__item ">
                    ...
                    <div class="category_specific__item__group">
                        <span class="category_specific__item__group__titlebis">L'agence web</span>
                        <span class="lightgrey"> " La où toute la magie opère " </span>                       
                        <a href="tiavina.php"><div class="button_purple"> Voir plus </div></a>
                    </div>
            </div>
