...
<<<<<<< HEAD
            <div class="article__group">
                <p>
                    ...
                    Il transforme des idées en images, afin de faire passer un message au public, à travers ses réalisations graphiques ( <span class="mediumgrey">logo, affiche, emballage, site internet</span> ). <br><br>
                    ...
                    S’ensuivent alors la création de la charte graphique ( <span class="mediumgrey"> définition des couleurs, de la typographie, du papier </span> ) et la réalisation ( <span class="mediumgrey"> conception et création, exécution et impression </span> ).
                </p>

                <img src="../assets/images/pictures/sonia_picture_one.jpg" alt="Artiste qui dessine sur tablette">
            ...
            <div class="article__group">
                ...
                <p>
                    Un moniteur. <br>
                    Un nuancier pantone ( <span class="mediumgrey">palette de couleurs</span> ). <br>
                    Une tablette graphique. <br>
                    Une imprimante ( <span class="mediumgrey"> multifonction, scanner, 300 dpi pour les photos / 600 dpi pour les illustrations </span> ). <br>
                    Un ou plusieurs stockages externes ( <span class="mediumgrey" > Clé usb, Disque dur externe, Cloud, Réseaux internet </span> ). <br>
                    Des logiciels comme la suite Adobe ( <span class="mediumgrey"> Photoshop, Illustrator, Dreamweaver </span> ) pour la création et retouche d’images, vidéos, photos. 
                   <br><br>
                    ...
                    <img src="../assets/images/pictures/sonia_picture_two.jpg" alt="Artiste qui réalise des esquisses"> 
